export function renderFooter(){
    ...
    <div class="px-10 mx-auto max-w-7xl">
        ...
        <div class="flex flex-col justify-between text-center md:flex-row">
            <p class="order-last text-sm leading-tight text-gray-500 md:order-first"> Built with ❤️ by Sebastián Gatica Developer. </p>
            <ul class="flex flex-row justify-center pb-3 -ml-4 -mr-4 text-sm">
                <li> <a href="#_" class="px-4 text-gray-500 hover:text-white">Projects</a> </li>
                <li> <a href="#_" class="px-4 text-gray-500 hover:text-white">Components</a> </li>
                <li> <a href="#_" class="px-4 text-gray-500 hover:text-white">Contact</a> </li>
                <li> <a href="#_" class="px-4 text-gray-500 hover:text-white">Products</a></li>
            </ul>
        </div>
    </div>
</section>
