...
export function renderTallStack() {
  return `
       <div class="p-8">
      <h1 class="mb-4 text-3xl text-white underline underline-offset-3 decoration-double decoration-2 decoration-gray-800 ">Stack TALL</h1>
      <p class="mb-4 text-white">La combinación de tenologias, Laravel, Livewire, AlpineJS y TailwindCSS, las cuales utilice en mis experiencias laborales.</p>
        ...
        <div x-data="{ 
         ...
         x-cloak>
            ...
            <div x-data="{ id: $id('accordion') }" class="cursor-pointer group">
                <button @click="setActiveAccordion(id)" class="flex items-center justify-between w-full p-4 text-left select-none group-hover:underline">
                    <span class="flex gap-x-2">Livewire
         ...
         x-cloak>
                    <div class="p-4 pt-0 opacity-70">
                        Experiencia con Alpinejs, en combinacion con Livewire.
                        Gestionando conexiones con javascript y Livewire, como por ej, API de Google maps, realizar operaciones relacionadas a la gestion de archivos con el S3 de AWS, utilizar mascaras para inputs numericos, o campos con un formato de texto especifico, metodos drag and drop para el ordenamiento de elementos, etc.
             ...
             <div x-data="{ id: $id('accordion') }" class="cursor-pointer group">
                <button @click="setActiveAccordion(id)" class="flex items-center justify-between w-full p-4 text-left select-none group-hover:underline">
                    <div class="flex gap-x-2">
                        <span class="text-white">TailwindCSS</span>
         ...
         x-cloak>
                    <div class="p-4 pt-0 opacity-70">
                        Desarrollo de estilos con TailwindCSS.
                        Manjeno de responsive, grids, flexboxs, animaciones de squeleton, tema oscuro.
                        Familiaridad con plugins de tailwind utilizados en Tailwind UI.
