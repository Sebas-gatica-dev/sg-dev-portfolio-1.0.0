export function renderTallStack() {
    return `
      <div class="p-8">
        <!-- Main Title -->
        ...
        <div x-data="{ 
          ...
          <!-- Section 1: Laravel -->
          <div x-data="{ id: $id('accordion-laravel') }" class="duration-200 ease-out relative w-full mx-auto overflow-hidden text-sm text-white font-normal bg-gray-700 border border-gray-600 divide-y divide-gray-600 rounded-md" x-cloak>
            <button @click="setActiveAccordion(id)" class="flex items-center justify-between w-full px-5 py-4 font-semibold text-left select-none">
              <div class="flex gap-x-2">
                ...
                <?xml version="1.0" encoding="UTF-8"?>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="22px" height="22px" viewBox="0 0 128 128" version="1.1">
                    <g id="surface1">
            ...
            <div x-show="activeAccordion==id" x-transition:enter="transition ease-out duration-200"
              ...
              <div class="p-5 pt-0 opacity-70">
                <ul class="list-disc pl-5 mt-4">
                  <li>Two years of experience building RESTful APIs and backend systems with Laravel.</li>
                  <li>Proficient in Eloquent ORM for database interactions and migrations.</li>
                  <li>Experience with Laravel packages like Passport for authentication and Horizon for queue management.</li>
                  <li>Implemented scalable solutions for real-time applications using Laravel Echo and WebSockets.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div x-data="{ id: $id('accordion-livewire') }" class="duration-200 ease-out relative w-full mx-auto overflow-hidden text-sm text-white font-normal bg-gray-700 border border-gray-600 divide-y divide-gray-600 rounded-md" x-cloak>
            ...
            <div x-show="activeAccordion==id" x-transition:enter="transition ease-out duration-200"
              ...
              <div class="p-5 pt-0 opacity-70">
                <ul class="list-disc pl-5 mt-4">
                  <li>Built dynamic, interactive UI components without leaving Laravel using Livewire.</li>
                  <li>Integrated Livewire with AlpineJS for seamless frontend interactivity.</li>
                  <li>Developed real-time features such as form validation, pagination, and modal dialogs.</li>
                  <li>Optimized performance by reducing unnecessary JavaScript dependencies.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <!-- Section 3: AlpineJS -->
          <div x-data="{ id: $id('accordion-alpinejs') }" class="duration-200 ease-out relative w-full mx-auto overflow-hidden text-sm text-white font-normal bg-gray-700 border border-gray-600 divide-y divide-gray-600 rounded-md" x-cloak>
            <button @click="setActiveAccordion(id)" class="flex items-center justify-between w-full px-5 py-4 font-semibold text-left select-none">
              <div class="flex gap-x-2">
                <span>AlpineJS</span>
            ...
            <div x-show="activeAccordion==id" x-transition:enter="transition ease-out duration-200"
              ...
              <div class="p-5 pt-0 opacity-70">
                <ul class="list-disc pl-5 mt-4">
                  <li>Two years of experience integrating AlpineJS with Livewire for lightweight interactivity.</li>
                  <li>Implemented features like drag-and-drop, input masking, and dynamic form handling.</li>
                  <li>Connected AlpineJS with third-party APIs (e.g., Google Maps, AWS S3).</li>
                  <li>Enhanced user experience with responsive animations and skeleton loaders.</li>
                </ul>
              </div>
            </div>
          </div>
  
          <!-- Section 4: TailwindCSS -->
          <div x-data="{ id: $id('accordion-tailwindcss') }" class="duration-200 ease-out relative w-full mx-auto overflow-hidden text-sm text-white font-normal bg-gray-700 border border-gray-600 divide-y divide-gray-600 rounded-md" x-cloak>
            <button @click="setActiveAccordion(id)" class="flex items-center justify-between w-full px-5 py-4 font-semibold text-left select-none">
              <div class="flex gap-x-2">
            ...
            <div x-show="activeAccordion==id" x-transition:enter="transition ease-out duration-200"
              ...
              <div class="p-5 pt-0 opacity-70">
                <ul class="list-disc pl-5 mt-4">
                  <li>Designed responsive and modern UIs using TailwindCSS.</li>
                  <li>Utilized utility-first classes for grids, flexbox, and animations.</li>
                  <li>Implemented dark mode and skeleton loaders for enhanced UX.</li>
                  <li>Familiarity with Tailwind plugins and Tailwind UI for rapid development.</li>
                </ul>
              </div>
            </div>
          </div>
