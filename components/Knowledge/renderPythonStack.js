export function renderPythonStack(){
    ...
    return `
      <div class="p-8">
        <h1 class="mb-4 text-3xl text-white underline underline-offset-3 decoration-double decoration-2 decoration-gray-800">Habilidades en Python</h1>
        <p class="mb-4 text-white ">Desarrollo de scripts en Python.</p>
        <span>Conocimientos en libreria como selenium, bs4, requests, flask.</span>
    <div x-data="{ 
        activeAccordion: '', 
