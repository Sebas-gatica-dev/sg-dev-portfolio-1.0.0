...
You can leave me a message on linkedin, and you are also invited to look at my personal projects on github        </p>
            <div class=" flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-2"> 
              ...
              <img src="https://res.cloudinary.com/db4xypidq/image/upload/v1738770785/linkedin-svgrepo-com_mhgnzc.svg" alt="LinkedIn"  class="w-10 h-10 object-cover" />
            ...
            <a href="https://github.com/Sebas-gatica-dev" target="_blank" rel="noopener noreferrer" class="flex gap-x-2  text-white font-semibold py-2 px-4 rounded-md transition duration-300">
              ...
              <img src="https://res.cloudinary.com/db4xypidq/image/upload/v1738770785/github-svgrepo-com_ss1dch.svg" alt="GitHub"  class="w-10 h-10 object-cover" />
